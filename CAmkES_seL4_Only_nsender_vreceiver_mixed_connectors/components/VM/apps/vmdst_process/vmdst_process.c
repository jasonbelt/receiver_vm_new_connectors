...
int main(int argc, char *argv[]) {
  ...
  char *sb_read_port_queue_name = argv[3];

  int sb_read_port_queue_length = atoi(argv[4]);
  ...
  char *sb_pacer_period_queue_name = argv[1];

  int sb_pacer_period_queue_length = atoi(argv[2]);
